...
// routes
// create a student
router.post("/create-student", sendImageToCloudinary_1.upload.single("file"), // parse the file system
...
// change user status
router.post("/change-status/:id", (0, auth_1.default)(user_constant_1.USER_ROLE.admin), user_controller_1.UserControllers.changeUserStatus);
// export routes
