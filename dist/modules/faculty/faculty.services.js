...
const getAllFacultiesFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const facultyQuery = new QueryBuilder_1.default(faculty_model_1.default.find().populate("academicDepartment"), query)
...
const getAFacultyFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield faculty_model_1.default.findById(id).populate("academicDepartment");
    return result;
});
// delete a single faculty
const deleteAFacultyFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const userExists = yield faculty_model_1.default.isFacultyExists(id);
    if (!userExists) {
    ...
    try {
        ...
        const deletedFaculty = yield faculty_model_1.default.findByIdAndUpdate(id, { isDeleted: true }, { new: true, session });
        if (!deletedFaculty) {
        ...
        yield session.endSession();
        throw new appError_1.default(http_status_1.default.BAD_REQUEST, "Failed to delete a faculty");
    }
});
// update a faculty into DB
const updateAFacultyFromDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield faculty_model_1.default.findByIdAndUpdate(id, { $set: flattenedPayload }, { new: true, runValidators: true });
    return result;
});
